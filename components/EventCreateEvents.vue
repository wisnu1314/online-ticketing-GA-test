        ...
        <div v-if="showForm" class="FormBox">
            ...
            <div class="FormContent">
                ...
                <b-form-group label="Deskripsi Event">
                    ...
                    <wysiwyg v-model="eventform.promotionalContent.description" aria-required="true"/>
                </b-form-group>
                <div>
            ...
            try {
                ...
                if(this.chances === 0){
                    ...
                    if (response.data.code === 200 && response.data.status === 'OK'){
                        ...
                        this.eventform.promotionalContent.description += `&nbsp;<div>${this.generatedContent}</div>`
